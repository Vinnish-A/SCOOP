...
- OmicVerse API lists preprocessing utilities including `scrublet`, PCA, neighbours, UMAP and Leiden. In this SOP, these are used as reference infrastructure or fallback wrappers, not as an all-in-one pipeline.
